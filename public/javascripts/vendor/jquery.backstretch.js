...
(function($) {
    ...
    $.backstretch = function(src, options, callback) {
        ...
        // Override rootElement with the passed in rootReference.
        // This is to be able to calculate a width/height based on something
        // other than the full window.
        if (settings.rootReference) { rootElement = settings.rootReference; }
